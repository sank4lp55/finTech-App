...
import 'package:frontend/views/pages/Homepage_folder/payment_folder/plateform_qr.dart';
...
class _UpiScreenState extends State<UpiScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   ),
      //   onPressed: () {
      //     details.amount = controllerAmount.text;
      //     details.message = controllerMessage.text;
      //     Navigator.push(
      //         context, MaterialPageRoute(builder: (_) => PlateformQr()));
      //     //Get.to(HomePage());
      //   },
      // ),
      body: SafeArea(
